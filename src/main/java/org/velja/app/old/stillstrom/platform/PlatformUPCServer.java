...
import org.velja.app.old.stillstrom.server.KeyStoreLoader;
...
@Getter
@Setter
public class PlatformUPCServer {
    private static final Logger logger = LoggerFactory.getLogger(PlatformUPCServer.class);
    private final OpcUaServer server;
    private final PlatformUPCNamespace platformUPCNamespace;
...
*/
    ...
    public PlatformUPCServer() throws Exception {
        ...
        logMessage("security dir: {} "+ securityTempDir.toAbsolutePath());
        logMessage("security pki dir: {}"+ pkiDir.getAbsolutePath());
        ...
        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
                ...
                .setApplicationName(LocalizedText.english("Platform UPC Server"))
                ...
                .setProductUri("urn:platform:opcua")
                .build();

        server = new OpcUaServer(serverConfig);
        platformUPCNamespace = new PlatformUPCNamespace(server);
        platformUPCNamespace.startup();
    }

    public CompletableFuture<OpcUaServer> startup() {
        logMessage(("PlatformUPCServer is started..."));
        return server.startup();
    }

    public CompletableFuture<OpcUaServer> shutdown() {
        platformUPCNamespace.shutdown();
    ...
    public static void main(String[] args) throws Exception {
        PlatformUPCServer server = new PlatformUPCServer();
        server.startup().get();
        logger.info("PlatformUPCServer is running...");
