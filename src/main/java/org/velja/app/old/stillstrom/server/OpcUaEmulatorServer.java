...
public class OpcUaEmulatorServer {
    ...
    public OpcUaEmulatorServer() throws Exception {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        OpcUaEmulatorServer server = new OpcUaEmulatorServer();

/*        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
                .setApplicationName(LocalizedText.english("OPC UA Emulator Server"))
                .setBuildInfo(new BuildInfo(
                        "urn:eclipse:milo:server",  // URI servera
                        "Eclipse Milo",
                        "OPC UA Emulator",
                        "1.0.0",
                        "1.0.0",
                        ...
                        Collections.singleton(
                                EndpointConfiguration.newBuilder()
                                        .setBindAddress("0.0.0.0")  // Dostupno svuda
                                        .setHostname("localhost")  // Ime hosta
                                        .setPath("/")  // Putanja do endpoint-a
                                        .setBindPort(4840)  // Port
                                        .build())).build();
